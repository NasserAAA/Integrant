...
INSERT IGNORE INTO authors(user_id)
...
VALUES ("Homo Deus",(select a.user_id from authors a inner join users u on a.user_id=u.user_id where u.email="Sam@mordor.com"),"Homo Deus Book By Samwise",150,true),
	   ("Homo Sapiens",(select a.user_id from authors a inner join users u on a.user_id=u.user_id where u.email="Sam@mordor.com"),"Homo Sapiens Book By Samwise",100,true),
	   ("A Brief History of Time",(select a.user_id from authors a inner join users u on a.user_id=u.user_id where u.email="Sam@mordor.com"),"A Brief History of Time Book By Samwise",50,true),
	   ("A Brief History of English Literature",(select a.user_id from authors a inner join users u on a.user_id=u.user_id where u.email="Sam@mordor.com"),"A Brief History of English Literature Book By Samwise",0,false);
